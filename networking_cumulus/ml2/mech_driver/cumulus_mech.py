...
class CumulusLBAgentMechanismDriver(mech_agent.SimpleAgentMechanismDriverBase):
    ...
    def create_network_postcommit(self, context):
        self.agent_notifier.create_network_cast(context.current)

    def delete_network_postcommit(self, context):
        LOG.debug("FIND ME: delete_network_postcommit")
        network = context.current
        segments = context.network_segments
        network_info={}
        self.agent_notifier.delete_network_cast(self.context, network_info)
